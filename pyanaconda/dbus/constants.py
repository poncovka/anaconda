...
STORAGE_BOOTLOADER_NAME = "{}.Bootloader".format(MODULE_STORAGE_NAME)
STORAGE_BOOTLOADER_PATH = auto_object_path(STORAGE_BOOTLOADER_NAME)

STORAGE_FCOE_NAME = "{}.FCOE".format(MODULE_STORAGE_NAME)
STORAGE_FCOE_PATH = auto_object_path(STORAGE_FCOE_NAME)

STORAGE_ISCSI_NAME = "{}.ISCSI".format(MODULE_STORAGE_NAME)
STORAGE_ISCSI_PATH = auto_object_path(STORAGE_ISCSI_NAME)

STORAGE_MOUNT_NAME = "{}.MountPointAssignment".format(MODULE_STORAGE_NAME)
STORAGE_MOUNT_PATH = auto_object_path(STORAGE_MOUNT_NAME)

STORAGE_PART_NAME = "{}.Partitioning".format(MODULE_STORAGE_NAME)
STORAGE_PART_PATH = auto_object_path(STORAGE_PART_NAME)

STORAGE_SELECTION_NAME = "{}.DiskSelection".format(MODULE_STORAGE_NAME)
STORAGE_SELECTION_PATH = auto_object_path(STORAGE_SELECTION_NAME)

STORAGE_SNAPSHOT_NAME = "{}.Snapshot".format(MODULE_STORAGE_NAME)
STORAGE_SNAPSHOT_PATH = auto_object_path(STORAGE_SNAPSHOT_NAME)

STORAGE_ZFCP_NAME = "{}.ZFCP".format(MODULE_STORAGE_NAME)
STORAGE_ZFCP_PATH = auto_object_path(STORAGE_ZFCP_NAME)
...
ANACONDA_MODULES = [(MODULE_FOO_NAME, MODULE_FOO_PATH),
                    ...
                    (MODULE_STORAGE_NAME, MODULE_STORAGE_PATH)]
