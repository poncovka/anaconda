...
from pyanaconda.users import cryptPassword, guess_username
...
from pyanaconda.regexes import GROUPNAME_VALID, GROUPLIST_FANCY_PARSE
...
class UserSpoke(FirstbootSpokeMixIn, NormalSpoke, GUISpokeInputCheckHandler):
    ...
    def initialize(self):
        ...
        self._checker = input_checking.PasswordChecker(initial_password_content = self.password,
    ...
    def _checks_done(self, error_message):
        ...
        if not error_message:
            ...
            if self.checker.policy.strict or unwaivable_check_failed:
                ...
                self.show_warning_message("%s %s" % (error_message, _(constants.PASSWORD_DONE_TWICE)))
