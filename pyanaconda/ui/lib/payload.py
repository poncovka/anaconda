...
def get_source(payload_proxy, source_type=None):
    ...
    If the payload has not sources and the default source type
    is not specified, raise an exception.

    :param payload_proxy: a DBus proxy of a payload
    :param source_type: a default source type or None
    :return: a DBus proxy of a source
