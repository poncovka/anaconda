...
def _prepare_configuration(payload, ksdata):
    ...
    addon_config.append(Task("Configure Anaconda addons", ksdata.addons.execute, (None, ksdata, None, payload)))
...
def _prepare_installation(payload, ksdata):
    ...
    setup_environment.append(Task("Setup addons", ksdata.addons.setup, (None, ksdata, payload)))
