...
__all__ = ["MountPointRequest", "DeviceFactoryRequest"]
...
class DeviceFactoryRequest(DBusData):
    ...
    @property
    def container_size_policy(self) -> Int:
    ...
    @property
    def container_size(self) -> UInt64:
        """Size of the container

        :return: a size in bytes
        """
        return UInt64(self._container_size)

    @container_size.setter
    def container_size(self, size: UInt64):
