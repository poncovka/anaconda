#
# DBus interface for partitioning.
#
...
# Red Hat, Inc.
#
from pyanaconda.dbus.constants import STORAGE_PART_NAME
...
@dbus_interface(STORAGE_PART_NAME)
class PartitioningInterface(AdvancedInterfaceTemplate):
    """DBus interface for the kickstart module."""

    @property
    def implementation(self) -> Partitioning:
