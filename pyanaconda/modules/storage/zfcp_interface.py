...
# Red Hat, Inc.
#
from pyanaconda.dbus.constants import STORAGE_ZFCP_NAME
...
@dbus_interface(STORAGE_ZFCP_NAME)
class ZFCPInterface(AdvancedInterfaceTemplate):
    """DBus interface for the kickstart module."""

    @property
    def implementation(self) -> ZFCPModule:
