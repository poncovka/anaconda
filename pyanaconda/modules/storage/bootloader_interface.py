#
# DBus interface for the bootloader.
#
...
# Red Hat, Inc.
#
from pyanaconda.dbus.constants import STORAGE_BOOTLOADER_NAME
...
@dbus_interface(STORAGE_BOOTLOADER_NAME)
class BootloaderInterface(AdvancedInterfaceTemplate):
    """DBus interface for the kickstart module."""

    @property
    def implementation(self) -> BootloaderModule:
