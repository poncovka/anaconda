...
# Red Hat, Inc.
#
from pyanaconda.dbus.constants import STORAGE_SNAPSHOT_NAME
...
@dbus_interface(STORAGE_SNAPSHOT_NAME)
class SnapshotInterface(AdvancedInterfaceTemplate):
    """DBus interface for the kickstart module."""

    @property
    def implementation(self) -> SnapshotModule:
