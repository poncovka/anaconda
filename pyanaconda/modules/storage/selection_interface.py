#
# DBus interface for disk selection.
#
...
# Red Hat, Inc.
#
from pyanaconda.dbus.constants import STORAGE_SELECTION_NAME
...
@dbus_interface(STORAGE_SELECTION_NAME)
class DiskSelectionInterface(AdvancedInterfaceTemplate):
    """DBus interface for the kickstart module."""

    @property
    def implementation(self) -> DiskSelectionModule:
