...
# Red Hat, Inc.
#
from pyanaconda.dbus.constants import STORAGE_FCOE_NAME
...
@dbus_interface(STORAGE_FCOE_NAME)
class FCOEInterface(AdvancedInterfaceTemplate):
    """DBus interface for the kickstart module."""

    @property
    def implementation(self) -> FCOEModule:
