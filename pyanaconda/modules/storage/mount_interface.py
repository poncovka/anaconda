#
# DBus interface for the mount point assignment.
#
...
# Red Hat, Inc.
#
from pyanaconda.dbus.constants import STORAGE_MOUNT_NAME
...
@dbus_interface(STORAGE_MOUNT_NAME)
class MountPointAssignmentInterface(AdvancedInterfaceTemplate):
    """DBus interface for the kickstart module."""

    @property
    def implementation(self) -> MountPointAssignment:
