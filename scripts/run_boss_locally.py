...
from pyanaconda.dbus.object import BOSS
...
def start_anaconda_services():
    ...
    test_dbus_connection.dbus.StartServiceByName(BOSS.DBUS_NAME, 0)
...
def distribute_kickstart(ks_path):
    ...
    boss_object = test_dbus_connection.get(BOSS.DBUS_NAME)
    try:
