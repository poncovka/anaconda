...
from pyanaconda.dbus.object import KICKSTART_MODULE, TIMEZONE
...
class TimezoneInterfaceTestCase(unittest.TestCase):
    ...
    def timezone_property_test(self):
        ...
        self.callback.assert_called_once_with(TIMEZONE.INTERFACE, {'Timezone': 'Europe/Prague'}, [])
    ...
    def utc_property_test(self):
        ...
        self.callback.assert_called_once_with(TIMEZONE.INTERFACE, {'IsUTC': True}, [])
    ...
    def ntp_property_test(self):
        ...
        self.callback.assert_called_once_with(TIMEZONE.INTERFACE, {'NTPEnabled': False}, [])
    ...
    def ntp_servers_property_test(self):
        ...
        self.callback.assert_called_once_with(TIMEZONE.INTERFACE, {'NTPServers': ["ntp.cesnet.cz"]}, [])
    ...
    def _test_kickstart(self, ks_in, ks_out):
        ...
        self.callback.assert_any_call(KICKSTART_MODULE.INTERFACE, {'Kickstarted': True}, [])
